...
```
[spack_dev_cpu@login02 ~]$ wget https://raw.githubusercontent.com/sdsc/spack/refs/heads/sdsc-0.17.3/configure-shared-spack-instance.sh
--2025-07-07 15:25:36--  https://raw.githubusercontent.com/sdsc/spack/refs/heads/sdsc-0.17.3/configure-shared-spack-instance.sh
...
configure-shared-spack-instance.sh           100%[===========================================================================================>]   2.45K  --.-KB/s    in 0s      

2025-07-07 15:25:37 (45.7 MB/s) - ‘configure-shared-spack-instance.sh’ saved [2505/2505]

[spack_dev_cpu@login02 ~]$ vi configure-shared-spack-instance.sh 
...
EOF
[spack_dev_cpu@login02 ~]$ chmod +x configure-shared-spack-instance.sh 
...
SSH_CONNECTION=198.202.100.14 52020 198.202.100.14 22
...
SSH_CLIENT=198.202.100.14 52020 22
LMOD_VERSION=8.2.4
