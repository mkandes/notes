...
You can check that the mlc-scripts (and the mlperf-automations) repo was also installed in your MLCFlow cache on local scratch with the following mlc command again.
*COMMAND*
```
mlc list repo
```
