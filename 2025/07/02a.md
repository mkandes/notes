...
[mkandes@exp-15-02 ~]$
```
You can also search and compare information about available conda packages via the web at https://anaconda.org/search. Please try to avoid using the defaults conda channel to avoid future licensing issues: https://www.anaconda.com/legal
