...
/scratch/mkandes/job_40801845/miniconda3/condabin/conda
...
# conda environments:
#
base                   /scratch/mkandes/job_40801845/miniconda3
mlcflow-dev          * /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev

[mkandes@exp-15-05 ~]$ conda list
# packages in environment at /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev:
#
...
Requirement already satisfied: requests in /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev/lib/python3.12/site-packages (from mlcflow) (2.32.4)
Requirement already satisfied: pyyaml in /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev/lib/python3.12/site-packages (from mlcflow) (6.0.2)
...
Requirement already satisfied: charset_normalizer<4,>=2 in /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev/lib/python3.12/site-packages (from requests->mlcflow) (3.4.2)
Requirement already satisfied: idna<4,>=2.5 in /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev/lib/python3.12/site-packages (from requests->mlcflow) (3.10)
Requirement already satisfied: urllib3<3,>=1.21.1 in /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev/lib/python3.12/site-packages (from requests->mlcflow) (2.5.0)
Requirement already satisfied: certifi>=2017.4.17 in /scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev/lib/python3.12/site-packages (from requests->mlcflow) (2025.6.15)
...
/scratch/mkandes/job_40801845/miniconda3/envs/mlcflow-dev/bin/mlc
[mkandes@exp-15-05 ~]$ mlc list repo
[2025-07-01 07:54:38,594 action.py:194 INFO] - Created repos.json in /scratch/mkandes/job_40801845/MLC and initialised with local cache folder path: /scratch/mkandes/job_40801845/MLC/repos/local
[2025-07-01 07:54:38,605 repo_action.py:467 INFO] - Listing all repositories.

Repositories:
-------------
- Alias: local
  Path:  /scratch/mkandes/job_40801845/MLC/repos/local

-------------
[2025-07-01 07:54:38,605 repo_action.py:474 INFO] - Repository listing ended
[mkandes@exp-15-05 ~]$
```


```
[mkandes@exp-15-05 ~]$ printenv | grep PYTHON
CONDA_PYTHON_EXE=/scratch/mkandes/job_40801845/miniconda3/bin/python
```
...
Submitted Jupyter launch script to Slurm. Your SLURM_JOB_ID is 40802168.
Success! Token linked to jobid.
Please copy and paste the HTTPS URL provided below into your web browser.
Do not share this URL with others. It is the password to your Jupyter notebook session.
Your Jupyter notebook session will begin once compute resources are allocated to your job by the scheduler.
https://mortified-deflate-trout.expanse-user-content.sdsc.edu/?token=3e17625946a98b5d79d527c803cafc39
...
# conda environments:
#
base                   /scratch/mkandes/job_40802168/miniconda3
mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu * /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu

[mkandes@exp-15-05 ~]$ conda list
# packages in environment at /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu:
#
# Name                                  Version          Build                     Channel
_libgcc_mutex                           0.1              conda_forge               conda-forge
_openmp_mutex                           4.5              2_gnu                     conda-forge
...
Collecting mlcflow
  Downloading mlcflow-1.0.18-py3-none-any.whl.metadata (19 kB)
Requirement already satisfied: requests in /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu/lib/python3.12/site-packages (from mlcflow) (2.32.4)
Requirement already satisfied: pyyaml in /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu/lib/python3.12/site-packages (from mlcflow) (6.0.2)
Collecting giturlparse (from mlcflow)
  Downloading giturlparse-0.12.0-py2.py3-none-any.whl.metadata (4.5 kB)
Collecting colorama (from mlcflow)
  Downloading colorama-0.4.6-py2.py3-none-any.whl.metadata (17 kB)
Requirement already satisfied: charset_normalizer<4,>=2 in /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu/lib/python3.12/site-packages (from requests->mlcflow) (3.4.2)
Requirement already satisfied: idna<4,>=2.5 in /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu/lib/python3.12/site-packages (from requests->mlcflow) (3.10)
Requirement already satisfied: urllib3<3,>=1.21.1 in /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu/lib/python3.12/site-packages (from requests->mlcflow) (2.5.0)
Requirement already satisfied: certifi>=2017.4.17 in /scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu/lib/python3.12/site-packages (from requests->mlcflow) (2025.6.15)
Downloading mlcflow-1.0.18-py3-none-any.whl (47 kB)
Downloading colorama-0.4.6-py2.py3-none-any.whl (25 kB)
Downloading giturlparse-0.12.0-py2.py3-none-any.whl (15 kB)
Installing collected packages: giturlparse, colorama, mlcflow
Successfully installed colorama-0.4.6 giturlparse-0.12.0 mlcflow-1.0.18
[mkandes@exp-15-05 ~]$ which mlc
/scratch/mkandes/job_40802168/miniconda3/envs/mlperf-inference-vision-image-classification-resnet50-imagenet-python-edge-onnxruntime-cpu/bin/mlc
[mkandes@exp-15-05 ~]$ mlc list repo
[2025-07-01 08:42:56,599 action.py:194 INFO] - Created repos.json in /home/mkandes/MLC and initialised with local cache folder path: /home/mkandes/MLC/repos/local
[2025-07-01 08:42:56,673 repo_action.py:467 INFO] - Listing all repositories.
...
-------------
[2025-07-01 08:42:56,673 repo_action.py:474 INFO] - Repository listing ended
[mkandes@exp-15-05 ~]$
```
