...
```
root@perfsonar-archive:~# vi /etc/apache2/conf-enabled/apache-logstash.conf
root@perfsonar-archive:~# systemctl restart apache2
root@perfsonar-archive:~# systemctl status apache2
● apache2.service - The Apache HTTP Server
     Loaded: loaded (/lib/systemd/system/apache2.service; enabled; vendor preset: enabled)
     Active: active (running) since Wed 2025-09-03 21:47:54 UTC; 9s ago
       Docs: https://httpd.apache.org/docs/2.4/
    Process: 14195 ExecStart=/usr/sbin/apachectl start (code=exited, status=0/SUCCESS)
   Main PID: 14199 (apache2)
      Tasks: 71 (limit: 35881)
     Memory: 23.4M
        CPU: 152ms
     CGroup: /system.slice/apache2.service
             ├─14199 /usr/sbin/apache2 -k start
             ├─14200 "elmond           " -k start
             ├─14201 "host_exporter    " -k start
             ├─14202 /usr/sbin/apache2 -k start
             └─14203 /usr/sbin/apache2 -k start

Sep 03 21:47:54 perfsonar-archive systemd[1]: Starting The Apache HTTP Server...
Sep 03 21:47:54 perfsonar-archive apachectl[14198]: [Wed Sep 03 21:47:54.150623 2025] [proxy:warn] [pid 14198:tid 129596826818432] AH01146: Ignoring param>
Sep 03 21:47:54 perfsonar-archive systemd[1]: Started The Apache HTTP Server.
root@perfsonar-archive:~#
```
...
perfsonar-testpoint-0:
  ...
  Checking services... Ticker... Scheduler... Runner... Archiver... OK.
  Checking limits... OK.
  Last run scheduled... 8 seconds ago
  Last run completed... 8 seconds ago
...
```
https://149.165.154.129/psconfig/3by3.json
```

```
root@perfsonar-testpoint-0:/var/log/perfsonar# tail -n 5 psconfig-pscheduler-agent.log
2025-09-03 22:24:52 INFO pid=11922 prog=resolve_address_multi line=110 msg=v6 lookup failed. Cannot resolve address fe80::f816:3eff:fe5c:181a. Error Message - All nameservers failed to answer the query fe80::f816:3eff:fe5c:181a. IN AAAA: Server 127.0.0.53 UDP port 53 answered SERVFAIL
2025-09-03 22:24:52 INFO pid=11922 prog=_run_start line=104 guid=4c680fb7-044a-4e82-9a79-4255889dbd3a pscheduler_assist_url=https://localhost/pscheduler match_addresses=["perfsonar-testpoint-0", "perfsonar-testpoint-0.js2local", "10.0.113.184", "fe80::f816:3eff:fe5c:181a%enp1s0", "172.17.0.1", "fe80::f816:3eff:fe5c:181a", "perfsonar-testpoint-0.local"] msg=Auto-detected match addresses
2025-09-03 22:24:52 ERROR pid=11922 prog=_process_psconfig line=345 guid=4c680fb7-044a-4e82-9a79-4255889dbd3a config_src=remote config_url=/root/3by3.json msg=Error loading psconfig: Can't open /root/3by3.json and load json. Error: [Errno 13] Permission denied: '/root/3by3.json'
2025-09-03 22:24:52 INFO pid=11922 prog=<module> line=112 guid=4c680fb7-044a-4e82-9a79-4255889dbd3a msg=Agent completed running
2025-09-03 22:24:52 INFO pid=11922 prog=<module> line=127 guid=4c680fb7-044a-4e82-9a79-4255889dbd3a msg=Time until next record refresh is 3599.9408299922943 seconds
root@perfsonar-testpoint-0:/var/log/perfsonar#
```
