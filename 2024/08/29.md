...
The primary issue you'll face if and when you attempt to replicate launching MPI applications on Expanse manually without builtin scheduler support is that most MPI distributions are quite good at auto-discovering the presence of many advanced features they can take advantage on your HPC system when you build and install them, even when you build them from source. This includes auto-discovery of a batch job schdeuler like Slurm available on Expanse. In fact, you actually have to explicitly disable Slurm support in OpenMPI with the `--without-slurm` flag during the build process.
...
Now that you have a working MPI distribution that you can run manually across multiple nodes on Expanse, go ahead and try a more interesting application. I would recommend you start with the OSU Micro-Benchmarks. Here is another build job script. 

```
#!/usr/bin/env bash

#SBATCH --job-name=omb-7.4-make
#SBATCH --account=use300
#SBATCH --clusters=expanse
#SBATCH --partition=ind-shared
#SBATCH --nodes=1
...
declare -xr OMB_MAJOR='7'
declare -xr OMB_MINOR='4'
declare -xr OMB_REV=''
declare -xr OMB_VERSION="${OMB_MAJOR}.${OMB_MINOR}"
declare -xr OMB_BUILD='default'
declare -xr OMB_ROOT_DIR="${HOME}/software/omb"
declare -xr OMB_INSTALL_DIR="${OMB_ROOT_DIR}/${OMB_VERSION}/${OMB_BUILD}/${COMPILER_MODULE}"
declare -xr OMB_ROOT_URL='http://mvapich.cse.ohio-state.edu'
...
wget "${OMB_ROOT_URL}/download/mvapich/osu-micro-benchmarks-${OMB_VERSION}.tar.gz"
...
Start with the point-to-point `osu_bw` and `osu_latency` benchmarks. 

```
[mkandes@exp-9-55 ~]$ declare -xr OMB_MAJOR='7'
[mkandes@exp-9-55 ~]$ declare -xr OMB_MINOR='4'
[mkandes@exp-9-55 ~]$ declare -xr OMB_VERSION="${OMB_MAJOR}.${OMB_MINOR}"
[mkandes@exp-9-55 ~]$ declare -xr OMB_BUILD='default'
[mkandes@exp-9-55 ~]$ declare -xr OMB_ROOT_DIR="${HOME}/software/omb"
[mkandes@exp-9-55 ~]$ declare -xr OMB_INSTALL_DIR="${OMB_ROOT_DIR}/${OMB_VERSION}/${OMB_BUILD}/${COMPILER_MODULE}"
[mkandes@exp-9-55 ~]$ export PATH="${OMB_INSTALL_DIR}/libexec/osu-micro-benchmarks/mpi/pt2pt:${PATH}"
[mkandes@exp-9-55 ~]$ which osu_bw
~/software/omb/7.4/default/gcc/8.5.0/libexec/osu-micro-benchmarks/mpi/pt2pt/osu_bw
[mkandes@exp-9-55 ~]$ which osu_latency
~/software/omb/7.4/default/gcc/8.5.0/libexec/osu-micro-benchmarks/mpi/pt2pt/osu_latency
[mkandes@exp-9-55 ~]$
```

```
[mkandes@exp-9-55 ~]$ mpirun -host exp-9-55,exp-9-56 --prefix "${OPENMPI_INSTALL_DIR}" -n 2 osu_bw
[1725406231.709007] [exp-9-55:434260:0]          parser.c:1993 UCX  WARN  unused environment variables: UCX_INSTALL_DIR; UCX_BUILD; UCX_MAJOR; UCX_VERSION; UCX_MINOR; UCX_ROOT_DIR; UCX_REV (maybe: UCX_TLS?)
[1725406231.709007] [exp-9-55:434260:0]          parser.c:1993 UCX  WARN  (set UCX_WARN_UNUSED_ENV_VARS=n to suppress this warning)
--------------------------------------------------------------------------
...
Node:       exp-9-56
Executable: /home/mkandes/software/omb/7.4/default/gcc/8.5.0/libexec/osu-micro-benchmarks/mpi/pt2pt/osu_bw
--------------------------------------------------------------------------
[mkandes@exp-9-55 ~]$ mpirun -host exp-9-55,exp-9-56 --prefix "${OPENMPI_INSTALL_DIR}" -n 2 -x PATH osu_bw
[1725406241.288730] [exp-9-55:434278:0]          parser.c:1993 UCX  WARN  unused environment variables: UCX_INSTALL_DIR; UCX_BUILD; UCX_MAJOR; UCX_VERSION; UCX_MINOR; UCX_ROOT_DIR; UCX_REV (maybe: UCX_TLS?)
[1725406241.288730] [exp-9-55:434278:0]          parser.c:1993 UCX  WARN  (set UCX_WARN_UNUSED_ENV_VARS=n to suppress this warning)
...
```
[mkandes@exp-9-55 ~]$ mpirun -host exp-9-55,exp-9-56 --prefix "${OPENMPI_INSTALL_DIR}" -n 2 osu_latency
[1725406271.324610] [exp-9-55:434514:0]          parser.c:1993 UCX  WARN  unused environment variables: UCX_INSTALL_DIR; UCX_BUILD; UCX_MAJOR; UCX_VERSION; UCX_MINOR; UCX_ROOT_DIR; UCX_REV (maybe: UCX_TLS?)
[1725406271.324610] [exp-9-55:434514:0]          parser.c:1993 UCX  WARN  (set UCX_WARN_UNUSED_ENV_VARS=n to suppress this warning)
--------------------------------------------------------------------------
mpirun was unable to find the specified executable file, and therefore
did not launch the job.  This error was first reported for process
rank 1; it may have occurred for other processes as well.
...
Node:       exp-9-56
Executable: /home/mkandes/software/omb/7.4/default/gcc/8.5.0/libexec/osu-micro-benchmarks/mpi/pt2pt/osu_latency
--------------------------------------------------------------------------
[mkandes@exp-9-55 ~]$ mpirun -host exp-9-55,exp-9-56 --prefix "${OPENMPI_INSTALL_DIR}" -n 2 -x PATH osu_latency
[1725406283.547853] [exp-9-55:434536:0]          parser.c:1993 UCX  WARN  unused environment variables: UCX_INSTALL_DIR; UCX_BUILD; UCX_MAJOR; UCX_VERSION; UCX_MINOR; UCX_ROOT_DIR; UCX_REV (maybe: UCX_TLS?)
[1725406283.547853] [exp-9-55:434536:0]          parser.c:1993 UCX  WARN  (set UCX_WARN_UNUSED_ENV_VARS=n to suppress this warning)
...
And then maybe start exploring UCX commands, options and environment variables ...

```
[mkandes@exp-9-55 ~]$ export UCX_MAX_RNDV_RAILS=1
[mkandes@exp-9-55 ~]$ export UCX_NET_DEVICES='mlx5_0:1'
[mkandes@exp-9-55 ~]$ mpirun -host exp-9-55,exp-9-56 --prefix "${OPENMPI_INSTALL_DIR}" -n 2 -x PATH -x UCX_MAX_RNDV_RAILS -x UCX_NET_DEVICES osu_bw
[1725406380.970556] [exp-9-55:434765:0]          parser.c:1993 UCX  WARN  unused environment variables: UCX_INSTALL_DIR; UCX_BUILD; UCX_MAJOR; UCX_VERSION; UCX_MINOR; UCX_ROOT_DIR; UCX_REV (maybe: UCX_TLS?)
[1725406380.970556] [exp-9-55:434765:0]          parser.c:1993 UCX  WARN  (set UCX_WARN_UNUSED_ENV_VARS=n to suppress this warning)
...
eno33np0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 9000
        ...
        RX packets 9239125  bytes 56923405501 (53.0 GiB)
        RX errors 0  dropped 0  overruns 0  frame 0
        TX packets 3649150  bytes 720917753 (687.5 MiB)
...
eno33np0.450: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 9000
        ...
        inet6 fe80::1e34:daff:fe72:e8ce  prefixlen 64  scopeid 0x20<link>
        ether 1c:34:da:72:e8:ce  txqueuelen 1000  (Ethernet)
        RX packets 457056  bytes 1125216334 (1.0 GiB)
        RX errors 0  dropped 0  overruns 0  frame 0
        TX packets 369534  bytes 113195501 (107.9 MiB)
        TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0
...
Infiniband hardware address can be incorrect! Please read BUGS section in ifconfig(8).
        ...
        RX packets 1762692  bytes 4656562292 (4.3 GiB)
        RX errors 0  dropped 0  overruns 0  frame 0
        TX packets 2006128  bytes 5363770666 (4.9 GiB)
        TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0
...
lo: flags=73<UP,LOOPBACK,RUNNING>  mtu 65536
        ...
        RX packets 1424483  bytes 275769728 (262.9 MiB)
        RX errors 0  dropped 0  overruns 0  frame 0
        TX packets 1424483  bytes 275769728 (262.9 MiB)
        TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0
