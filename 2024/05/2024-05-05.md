...
- data_center_compute_host_000
- data_center_compute_container
- Port IP address: 10.0.4.77
- Floating IP address": 10.189.10.59


```
sed s/#PermitRootLogin prohibit-password/PermitRootLogin yes/g /etc/sshd/sshd_config
```
