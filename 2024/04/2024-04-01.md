...
```
mckandes@ara-jbox:~$ ssh root@10.189.11.94
The authenticity of host '10.189.11.94 (10.189.11.94)' can't be established.
ECDSA key fingerprint is SHA256:KwByPEvHD2RM1AzhygPKiogii+g7qg0rzfrXLNwdFdQ.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added '10.189.11.94' (ECDSA) to the list of known hosts.
