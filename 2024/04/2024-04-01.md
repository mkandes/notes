...
To create a lease, first navigate to the *Project* tab and select *Reservations*, then click on the *Leases* category. You should be able to find a **+ create Lease** button in on the right hand side of the *Leases* 
