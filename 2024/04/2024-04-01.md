...
After providing a **Lease Name**, **Start Date**, and **End Date* under the *General* lease settings tab, click on the **Next** button in the bottom right to move to the *Resources* tab. To run this Hello, World Experiment on the Agronomy Farm's Edge Compute Node, select the *Agronomy Farm* as the **Site** from dropdown list, the *Compute Node* as the **Resource Type**, the *Edge* as the **Device Type**, and then set *000* as the **Device ID**. 
