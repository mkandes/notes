...
The benchmark run successfully thus far on a single Gaudi2 with different hyperparameter configurations. Unfortuantely, however, the multi-card, single-node configurations is also failing on Gaudi2. 
