...
commit of the release version you have targeted for the upgrade. If it is ahead of the release commit, then you should also find its version number tag listed as one of the tags available in the `sdsc/spack` repo. 
