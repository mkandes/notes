...
```
mkandes@hardtack:~$ zpool list
NAME    SIZE  ALLOC   FREE  CKPOINT  EXPANDSZ   FRAG    CAP  DEDUP    HEALTH  ALTROOT
bpool  1.88G   319M  1.56G        -         -     9%    16%  1.00x    ONLINE  -
rpool  1.84T  1.49T   364G        -         -    20%    80%  1.00x    ONLINE  -
mkandes@hardtack:~$
```

```
mkandes@hardtack:~$ zpool status
  pool: bpool
 state: ONLINE
  scan: scrub repaired 0B in 00:00:00 with 0 errors on Sun Jan 11 00:24:01 2026
config:

	NAME                                               STATE     READ WRITE CKSUM
	bpool                                              ONLINE       0     0     0
	  nvme-eui.36355830526271740025384600000001-part2  ONLINE       0     0     0

errors: No known data errors

  pool: rpool
 state: ONLINE
  scan: scrub repaired 0B in 00:08:09 with 0 errors on Sun Jan 11 00:32:10 2026
config:

	NAME                                                           STATE     READ WRITE CKSUM
	rpool                                                          ONLINE       0     0     0
	  nvme-PM9A1_NVMe_Samsung_2048GB_______S65XNF0R627174_1-part4  ONLINE       0     0     0
...
- https://discourse.practicalzfs.com/t/boot-pool-snapshot-strategy/589
