...
```
mkandes@hardtack:~$ apt list ---installed | grep virt

WARNING: apt does not have a stable CLI interface. Use with caution in scripts.

gir1.2-libvirt-glib-1.0/noble,now 5.0.0-2build3 amd64 [installed,automatic]
libvirt-clients/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 amd64 [installed,automatic]
libvirt-daemon-config-network/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 all [installed,automatic]
libvirt-daemon-config-nwfilter/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 all [installed,automatic]
libvirt-daemon-driver-qemu/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 amd64 [installed,automatic]
libvirt-daemon-system-systemd/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 all [installed,automatic]
libvirt-daemon-system/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 amd64 [installed,automatic]
libvirt-daemon/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 amd64 [installed,automatic]
...
libvirt-l10n/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 all [installed,automatic]
libvirt0/noble-updates,noble-security,now 10.0.0-2ubuntu8.11 amd64 [installed,automatic]
...
virt-viewer/noble,now 11.0-3build2 amd64 [installed]
...
Check if virtualization hardware extensions are enabled in BIOS.

```
mkandes@hardtack:~$ sudo systemctl status libvirtd
○ libvirtd.service - libvirt legacy monolithic daemon
     Loaded: loaded (/usr/lib/systemd/system/libvirtd.service; enabled; preset: enabled)
     Active: inactive (dead) since Fri 2026-01-16 19:15:08 PST; 12min ago
   Duration: 2min 114ms
TriggeredBy: ● libvirtd-admin.socket
       ...
       Docs: man:libvirtd(8)
             https://libvirt.org/
    Process: 149016 ExecStart=/usr/sbin/libvirtd $LIBVIRTD_ARGS (code=exited, status=0/SUCCESS)
   Main PID: 149016 (code=exited, status=0/SUCCESS)
      Tasks: 2 (limit: 32768)
     Memory: 5.7M (peak: 14.8M)
        CPU: 714ms
     CGroup: /system.slice/libvirtd.service
             ├─149124 /usr/sbin/dnsmasq --conf-file=/var/lib/libvirt/dnsmasq/default.conf --leasefile-ro --d>
             └─149125 /usr/sbin/dnsmasq --conf-file=/var/lib/libvirt/dnsmasq/default.conf --leasefile-ro --d>

Jan 16 19:13:09 hardtack dnsmasq-dhcp[149124]: DHCP, IP range 192.168.122.2 -- 192.168.122.254, lease time 1h
Jan 16 19:13:09 hardtack dnsmasq-dhcp[149124]: DHCP, sockets bound exclusively to interface virbr0
Jan 16 19:13:09 hardtack dnsmasq[149124]: reading /etc/resolv.conf
Jan 16 19:13:09 hardtack dnsmasq[149124]: using nameserver 127.0.0.53#53
Jan 16 19:13:09 hardtack dnsmasq[149124]: read /etc/hosts - 8 names
Jan 16 19:13:09 hardtack dnsmasq[149124]: read /var/lib/libvirt/dnsmasq/default.addnhosts - 0 names
Jan 16 19:13:09 hardtack dnsmasq-dhcp[149124]: read /var/lib/libvirt/dnsmasq/default.hostsfile
Jan 16 19:15:08 hardtack systemd[1]: libvirtd.service: Deactivated successfully.
Jan 16 19:15:08 hardtack systemd[1]: libvirtd.service: Unit process 149124 (dnsmasq) remains running after u>
Jan 16 19:15:08 hardtack systemd[1]: libvirtd.service: Unit process 149125 (dnsmasq) remains running after u>
mkandes@hardtack:~$
```
